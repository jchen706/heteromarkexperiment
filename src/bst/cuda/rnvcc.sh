nvcc -arch=sm_61 bst_command_line_options.cc bst_benchmark.cc main.cc bst_cuda_benchmark.cu ./src/common/command_line_option/benchmark_command_line_options.cc \
