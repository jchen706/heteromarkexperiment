...
clang++ -emit-llvm test.cc --cuda-gpu-arch=sm_61 -O3 -c -pthread
...
llc --relocation-model=pic --filetype=obj  test.bc
...
g++ -g -std=c++14 -Wno-uninitialized -Wall -L/data/jchen/open_source_template/build/runtime  -L/data/jchen/open_source_template/build/runtime/threadPool -o test -fPIC -no-pie ${COMMON} aes_command_line_options.o aes_benchmark.o test.o host.o kernel.o -lc -lx86Runtime -lthreadPool -lpthread





./test -i ../../data/aes/test.data -k ../../data/aes/key.data 
