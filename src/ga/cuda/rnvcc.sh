nvcc -arch=sm_61 ga_command_line_options.cc ga_benchmark.cc main.cc ga_cuda_benchmark.cu ./src/common/command_line_option/benchmark_command_line_options.cc \
