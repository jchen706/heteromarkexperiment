nvcc -arch=sm_61 pr_command_line_options.cc pr_benchmark.cc main.cc pr_cuda_benchmark.cu ./src/common/command_line_option/benchmark_command_line_options.cc \
